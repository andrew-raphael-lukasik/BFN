...
public class BFN_Tests
{
	...
	[Test] public void equal__default_default_compressed () => Assert.AreEqual( expected: default(BFN) , actual: default(BFN).compressed );
    [Test] public void equal__1e0_1e0_compressed () => Assert.AreEqual( expected:new BFN(1,0) , actual:new BFN(1,0).compressed );
    
    [Test] public void non_equal__1e3_1e3_compressed () => Assert.AreNotEqual( expected:new BFN(1,3) , actual:new BFN(1000,0) );
